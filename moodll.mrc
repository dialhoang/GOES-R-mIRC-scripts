...
alias netdrive {
  if ($round($calc(($disk(c).free)/1048576),2) > 1) { set %disk1 [10dubyadee60: 10 $round($calc(($disk(c).free)/1073741824),2) $+ Gb10] } 
  if ($round($calc(($disk(d).free)/1048576),2) > 1) { set %disk2 [10phatone: 10 $round($calc(($disk(d).free)/1073741824),2) $+ Gb10] } 
  if ($round($calc(($disk(e).free)/1048576),2) > 1) { set %disk3 [10phattwo:10 $round($calc(($disk(e).free)/1073741824),2) $+ Gb10] } 
  if ($round($calc(($disk(f).free)/1048576),2) > 1) { set %disk4 [10assdrive: 10 $round($calc(($disk(f).free)/1073741824),2) $+ Gb10] } 
  set %disktotal $round($calc((($disk(c).free)+($disk(d).free)+($disk(e).free)+($disk(f).free))/1073741824),2) 

  say 3 Space Free10 %disk1 
  say 3 Space Free10 %disk2  
  say 3 Space Free10 %disk3 
  say 3 Space Free10 %disk4  
